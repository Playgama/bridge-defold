...
using CallbacksWithJsonAndStringFunction = void(UniversalHandler, const char* json, const char* str, dmScript::LuaCallbackInfo* onSuccess, dmScript::LuaCallbackInfo* onFailure);
